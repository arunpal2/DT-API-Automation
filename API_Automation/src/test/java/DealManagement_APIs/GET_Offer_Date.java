...
public class GET_Offer_Date 
{
    ...
    public static void setup() 
	{
	 ...
	 @Test
     public void Test_GET_Offer_Date()
	 {	 
		 System.out.println("******************* GET OFFER DATE **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("GET_OFFER_DATE")); 
		  ...
		  /*
	        ...
	        */
 			...
 			System.out.println("****************************** End of GET OFFER DATE Test ******************************");
 			System.out.println("\n");
