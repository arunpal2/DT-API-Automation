...
public class POST_Price_Landing_Page_Context_Menu_Remove_from_production_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 				
	 ...
	 @Test
     public void Test_POST_Price_Landing_Page_Context_Menu_Remove_from_production_API() throws IOException
	 {	 
		 System.out.println("******************* POST Price Landing_Page Context Menu Remove from production API **************************");
		 System.out.println("\n");
		 OkHttpClient client = new OkHttpClient().newBuilder()
				...
				Request request = new Request.Builder()
				  .url(ReadProperty.getProperty("Price_Landing_Page_Context_Menu_Remove_from_production_POST_URL"))
				  .method("POST", body)
		  ...
		  /*
		   ...
		   int statusCode = response.code();
			...
			//Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of POST Price Landing_Page Context Menu Remove from production Test ******************************");
 			System.out.println("\n");
