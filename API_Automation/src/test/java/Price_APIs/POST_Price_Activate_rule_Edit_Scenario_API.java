...
public class POST_Price_Activate_rule_Edit_Scenario_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 				
	 ...
	 @Test
     public void Test_POST_Price_Activate_rule_Edit_Scenario_API() throws IOException
	 {	 
		 System.out.println("******************* POST Price Activate rule Edit Scenario API **************************");
		 System.out.println("\n");
				 ...
				 OkHttpClient client = new OkHttpClient().newBuilder()
						...
						Request request = new Request.Builder()
						  .url(ReadProperty.getProperty("Price_Activate_rule_Edit_Scenario"))
						  .method("POST", body)
 			...
 			System.out.println("****************************** End of POST Price Activate rule Edit Scenario Test ******************************");
 			System.out.println("\n");
     }
}
