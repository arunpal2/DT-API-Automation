...
public class Price_Edit_scenario_icon_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Price_Edit_scenario_icon_API()
	 {	 
		 System.out.println("******************* GET Price Edit Scenario Icon API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Price_Edit_scenario_icon_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Price Edit Scenario Icon API ******************************");
 			System.out.println("\n");
