...
public class Price_Scenario_Run_Id_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Price_Scenario_Run_Id_API()
	 {	 
		 System.out.println("******************* GET Price Scenario Run Id API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Price_Scenario_Run_Id_URL")); 	
		 
		 
		 	String jsonObject = response.getBody().asString();
			//tokenType = jsonObject.get("RunID").toString();

		 	

			
			System.out.println("Scenario Run Id is::::::::::::: " +tokenType); 
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Price Scenario Run Id API ******************************");
 			System.out.println("\n");
