...
public class Price_Scenario_history_API_to_fetch_Run_ID_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Price_Scenario_history_API_to_fetch_Run_ID_API()
	 {	 
		 System.out.println("******************* GET Price Scenario history API to fetch Run ID API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Price_Scenario_history_API_to_fetch_Run_ID_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of Price Scenario history API to fetch Run ID API ******************************");
 			System.out.println("\n");
