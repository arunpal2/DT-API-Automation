...
public class Price_Details_page_Rules_Exception_report_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Price_Details_page_Rules_Exception_report_API()
	 {	 
		 System.out.println("******************* GET Price Details page Rules Exception report API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Price_Details_page_Rules_Exception_report_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of Price Details page Rules Exception report API ******************************");
 			System.out.println("\n");
