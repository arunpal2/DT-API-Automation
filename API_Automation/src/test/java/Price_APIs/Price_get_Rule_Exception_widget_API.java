...
public class Price_get_Rule_Exception_widget_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Price_get_Rule_Exception_widget_API()
	 {	 
		 System.out.println("******************* GET Price get Rule Exception widget API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Price_get_Rule_Exception_widget_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of Price get Rule Exception widget API ******************************");
 			System.out.println("\n");
