...
public class Price_Get_advanced_override_price_actions_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Price_Get_advanced_override_price_actions_API()
	 {	 
		 System.out.println("******************* GET Price Get advanced override price actions API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Price_Get_advanced_override_price_actions_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of Price GET advanced override price actions API ******************************");
 			System.out.println("\n");
