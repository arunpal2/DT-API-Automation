...
public class Price_New_Scenario_Run_Rules_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Price_New_Scenario_Run_Rules_API()
	 {	 
		 System.out.println("******************* GET Price New Scenario Run Rules API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Price_New_Scenario_Run_Rules_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of Price New Scenario Run Rules API ******************************");
 			System.out.println("\n");
