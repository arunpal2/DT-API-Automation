...
public class Price_Scenario_Compare_ChartMetrics_URL 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Price_Scenario_Compare_ChartMetrics_URL_API()
	 {	 
		 System.out.println("******************* GET Price Scenario compare Chart Metrics API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Price_Scenario_Compare_ChartMetrics_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Price Scenario compare Chart Metrics API ******************************");
 			System.out.println("\n");
