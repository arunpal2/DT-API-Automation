...
public class POST_Price_Custom_Report_Creation_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 				
	 ...
	 @Test
     public void Test_POST_Price_Custom_Report_Creation_API()
	 {	 
		 System.out.println("******************* POST POST Price Custom Report Creation API **************************");
		 System.out.println("\n");
...
//		 Response response = httpRequest.post("https://qa01.demandtec.com/demandtec/products/pricing/api/scenario/action/duplicateWith?runId=15316"); 		 		
		 ...
		 String BASE_URI =  ReadProperty.getProperty("Price_Custom_Report_Creation_POST_URL");
		 ...
		 String SCOPE = ReadProperty.getProperty("SCOPE");	
		  ...
		  /*
	        ...
	        */
 			...
 			System.out.println("****************************** End of POST Price Custom Report Creation Test ******************************");
 			System.out.println("\n");
