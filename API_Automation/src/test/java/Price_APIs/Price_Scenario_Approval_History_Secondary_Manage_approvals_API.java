...
public class Price_Scenario_Approval_History_Secondary_Manage_approvals_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Price_Scenario_Approval_History_Secondary_Manage_approvals_API()
	 {	 
		 System.out.println("******************* GET Price Scenario Approval History Secondary Manage approvals API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Price_Scenario_Approval_History_Secondary_Manage_approvals_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of Price Scenario Approval History Secondary Manage approvals API ******************************");
 			System.out.println("\n");
