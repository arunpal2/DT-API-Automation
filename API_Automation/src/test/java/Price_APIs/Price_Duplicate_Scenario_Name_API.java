...
public class Price_Duplicate_Scenario_Name_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Price_is_Duplicate_Scenario_Name_API()
	 {	 
		 System.out.println("******************* GET Price Is Duplicate Scenario Name API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Price_is_Duplicate_Scenario_Name_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of Price Is Duplicate Scenario Name API ******************************");
 			System.out.println("\n");
