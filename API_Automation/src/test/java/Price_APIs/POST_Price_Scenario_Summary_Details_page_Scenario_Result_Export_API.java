...
public class POST_Price_Scenario_Summary_Details_page_Scenario_Result_Export_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 				
	 ...
	 @Test
     public void Test_POST_Price_Scenario_Summary_Details_page_Scenario_Result_Export_API() throws IOException
	 {	 
		 System.out.println("******************* POST Price New Scenario Summary Details page Scenario Result Export API **************************");
		 System.out.println("\n");
				 ...
				 OkHttpClient client = new OkHttpClient().newBuilder()
						...
						RequestBody body = RequestBody.create(mediaType, "{\"filters\":[],\"sorts\":[{\"value\":\"NONE\"}],\"exportType\":\"CSV\"}");
						
						Request request = new Request.Builder()
						  .url(ReadProperty.getProperty("Price_Scenario_Summary_Details_page_Scenario_Result_Export_POST_API"))
						  .method("POST", body)
 			...
 			System.out.println("****************************** End of POST Price New Scenario Summary Details page Scenario Result Expor Test ******************************");
 			System.out.println("\n");
     }
}
