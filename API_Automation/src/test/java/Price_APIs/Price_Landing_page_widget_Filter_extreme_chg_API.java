...
public class Price_Landing_page_widget_Filter_extreme_chg_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 				
	 ...
	 @Test
     public void Test_Price_Landing_page_widget_Filter_extreme_chg_API()
	 {	 
		 System.out.println("******************* GET Landing page widget Filter extreme chg API **************************");
		 System.out.println("\n");
...
//		 Response response = httpRequest.post("https://qa01.demandtec.com/demandtec/products/pricing/api/scenario/action/duplicateWith?runId=15316"); 		 		
		 
		 String BASE_URI =  ReadProperty.getProperty("Price_Landing_page_widget_Filter_extreme_chg_URL");
		 
		 String HOST = ReadProperty.getProperty("HOST");
		 String COOKIE = ReadProperty.getProperty("COOKIE");	
		 String SCOPE = ReadProperty.getProperty("SCOPE");	
									
			Response response = given()
					.header("Host", HOST)
					.header("Cookie",COOKIE).when()
		  ...
		  /*
	        ...
	        */
 			...
 			System.out.println("****************************** End of GET Landing page widget Filter extreme chg API Test ******************************");
 			System.out.println("\n");
