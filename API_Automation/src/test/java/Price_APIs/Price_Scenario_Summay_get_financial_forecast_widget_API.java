...
public class Price_Scenario_Summay_get_financial_forecast_widget_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Price_Scenario_Summay_get_financial_forecast_widget_API()
	 {	 
		 System.out.println("******************* GET Price Scenario Summay get financial forecast widget API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Price_Scenario_Summay_get_financial_forecast_widget_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Price Scenario Summay get Log API ******************************");
 			System.out.println("\n");
