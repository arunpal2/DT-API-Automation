...
public class POST_Price_Deactivate_rule_Edit_Scenario_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 				
	 ...
	 @Test
     public void Test_POST_Price_Deactivate_rule_Edit_Scenario_API() throws IOException
	 {	 
		 System.out.println("******************* POST Price Deactivate rule Edit Scenario API **************************");
		 System.out.println("\n");
				 ...
				 OkHttpClient client = new OkHttpClient().newBuilder()
						...
						RequestBody body = RequestBody.create(mediaType, "{\"updateCells\":[{\"id\":710581,\"column\":\"Active\",\"value\":true}]}");
						
						Request request = new Request.Builder()
						  .url(ReadProperty.getProperty("Price_Deactivate_rule_Edit_Scenario"))
						  .method("POST", body)
 			...
 			System.out.println("****************************** End of POST Price Deactivate rule Edit Scenario Test ******************************");
 			System.out.println("\n");
     }
}
