...
public class POST_Price_Update_multiple_override_Scenario_Results_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 				
	 ...
	 @Test
     public void Test_POST_Price_Update_multiple_override_Scenario_Results_API() throws IOException
	 {	 
		 System.out.println("******************* POST Price Update multiple override Scenario Results API **************************");
		 System.out.println("\n");
				 ...
				 OkHttpClient client = new OkHttpClient().newBuilder()
						...
						RequestBody body = RequestBody.create(mediaType, "{\"updateCells\":[{\"id\":328361655,\"column\":\"OverridePrice\",\"value\":\"2\"},{\"id\":328361656,\"column\":\"OverridePrice\",\"value\":\"2\"}]}");
						
						Request request = new Request.Builder()
						  .url(ReadProperty.getProperty("Price_Update_multiple_override_Scenario_Results_POST_URL"))
						  .method("POST", body)
 			...
 			System.out.println("****************************** End of POST Price Update multiple override Scenario Results Test ******************************");
 			System.out.println("\n");
     }
}
