...
public class Price_Get_Advanced_override_Modal_Scenario_Results_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Price_Get_Advanced_override_Modal_Scenario_Results_API()
	 {	 
		 System.out.println("******************* GET Price Get Advanced override Modal Scenario Results API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Price_Get_Advanced_override_Modal_Scenario_Results_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Advanced override Modal Scenario Results API ******************************");
 			System.out.println("\n");
