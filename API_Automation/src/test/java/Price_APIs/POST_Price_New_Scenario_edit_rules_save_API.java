...
public class POST_Price_New_Scenario_edit_rules_save_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 				
	 ...
	 @Test
     public void Test_POST_Price_New_Scenario_edit_rules_save_API() throws IOException
	 {	 
		 System.out.println("******************* POST Price New Scenario edit rules save API **************************");
		 System.out.println("\n");
				 ...
				 OkHttpClient client = new OkHttpClient().newBuilder()
						...
						RequestBody body = RequestBody.create(mediaType, "{\"catId\":46,\"divId\":20,\"ruleType\":4,\"name\":\"Size Rule\",\"description\":\"The retail price of each larger product must be at least 2% above the corresponding next smaller product.The equivalent price of each larger product must be at least -1% below the corresponding next smaller product.\",\"productGroupId\":47,\"rightProductGroupId\":47,\"leftProductId\":null,\"rightProductId\":null,\"locationGroupId\":21,\"metric\":0,\"scope\":1,\"limit\":3,\"scale\":0,\"lowerBound\":\"2\",\"upperBound\":-1,\"leftClassGroup\":\"\",\"rightClassGroup\":\"\",\"cpiId\":null,\"compTimeHorizon\":null,\"zoneGroupId\":null,\"lastDigits\":null,\"thirdDigits\":null,\"rightScope\":null,\"customRelationshipType\":null,\"multiplierType\":null,\"channelType\":null,\"aggregation\":null,\"priceType\":null,\"lowerBounds\":null,\"upperBounds\":null,\"options\":null,\"scenarioRunRuleId\":715378,\"scenarioRunId\":17848,\"newRule\":false,\"compliance\":false,\"competitorIds\":null,\"baseZoneIds\":null,\"secondaryZoneIds\":null}\r\n");
						
						Request request = new Request.Builder()
						  .url(ReadProperty.getProperty("Price_New_Scenario_edit_rules_save"))
						  .method("POST", body)
 			...
 			System.out.println("****************************** End of POST Price New Scenario edit rules save Test ******************************");
 			System.out.println("\n");
     }
}
