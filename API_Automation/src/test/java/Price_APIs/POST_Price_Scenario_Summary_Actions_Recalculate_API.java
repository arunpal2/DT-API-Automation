...
public class POST_Price_Scenario_Summary_Actions_Recalculate_API 
{
	private static final String BASE_URI = null;
...
//		System.out.println("Access Token is:::::: " +accessToken); 				
	 ...
	 @Test
     public void Test_POST_Price_Detailed_Scenario_POST_URL_API() throws IOException
	 {	 
		 System.out.println("******************* POST POST Price Duplicate Scenario With results API **************************");
		 System.out.println("\n");
		 ...
		 OkHttpClient client = new OkHttpClient().newBuilder()
				...
				Request request = new Request.Builder()
				  .url(ReadProperty.getProperty("Price_Scenario_Summary_Actions_Recalculate"))
				  .method("POST", body)
		  ...
		  /*
		   ...
		   int statusCode = response.code();
 			...
 			System.out.println("****************************** End of POST Price Duplicate Scenario With results Test ******************************");
 			System.out.println("\n");
