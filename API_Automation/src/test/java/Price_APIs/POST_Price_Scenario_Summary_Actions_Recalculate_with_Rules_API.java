...
public class POST_Price_Scenario_Summary_Actions_Recalculate_with_Rules_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 				
	 ...
	 @Test
     public void Test_POST_Price_Copy_API() throws IOException
	 {	 
		 System.out.println("******************* POST Price Scenario Summary Actions Recalculate with Rules **************************");
		 System.out.println("\n");
		 ...
		 OkHttpClient client = new OkHttpClient().newBuilder()
				...
				Request request = new Request.Builder()
				  .url(ReadProperty.getProperty("Price_Scenario_Summary_Actions_Recalculate_with_Rules_POST_URL"))
				  .method("POST", body)
		  ...
		  /*
		   ...
		   int statusCode = response.code();
			...
			//Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of POST Price Scenario Summary Actions Recalculate with Rules Test ******************************");
 			System.out.println("\n");
