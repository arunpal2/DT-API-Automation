...
public class POST_Price_Scenario_Summary_Scenario_Settings_report_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 				
	 ...
	 @Test
     public void Test_POST_Save_Comment_API_API()
	 {	 
		 System.out.println("******************* POST Price Save Comments API **************************");
		 System.out.println("\n");
...
//		 Response response = httpRequest.post("https://qa01.demandtec.com/demandtec/products/pricing/api/scenario/action/duplicateWith?runId=15316"); 		 		
		 ...
		 String BASE_URI =  ReadProperty.getProperty("Price_Scenario_Summary_Scenario_Settings_report_POST_URL");
		 ...
		 String SCOPE = ReadProperty.getProperty("SCOPE");	
		  ...
		  /*
	        ...
	        */
 			...
 			System.out.println("****************************** End of POST Price Save Comments Test ******************************");
 			System.out.println("\n");
