...
public class Price_Action_Compare_scenarios_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Price_Action_Compare_scenarios_API()
	 {	 
		 System.out.println("******************* GET Price Competitive rules report API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Price_Competitive_rules_report_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Price Competitive rules report API ******************************");
 			System.out.println("\n");
