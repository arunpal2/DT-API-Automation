...
public class Price_Context_Menu_Approve_for_Export_Dialogue_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Price_Context_Menu_Approve_for_Export_Dialogue_API()
	 {	 
		 System.out.println("******************* GET Price Context Menu Approve for Export Dialogue API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Price_Context_Menu_Approve_for_Export_Dialogue_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of Price Context Menu Approve for Export Dialogue API ******************************");
 			System.out.println("\n");
