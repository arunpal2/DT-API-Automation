...
public class POST_Price_New_Scenario_Add_Rule_Group_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 				
	 ...
	 @Test
     public void Test_POST_Price_New_Scenario_Add_Rule_Group_API()
	 {	 
		 System.out.println("******************* POST Price New Scenario Add Rule Group Test API **************************");
		 System.out.println("\n");
		 
			//  Create a Request pointing to the Service Endpoint and make a GET Request.
					 //RequestSpecification request = RestAssured.given();
				RequestSpecification httpRequest = given()
					 .header("Cookie",ReadProperty.getProperty("COOKIE"))
					 .header("Host", ReadProperty.getProperty("HOST"))
					 .header("Content-Type",ReadProperty.getProperty("CONTENT_TYPE"));	
					 
				JSONObject requestParams = new JSONObject();
				 
				// Getting values from Property File.
				//requestParams.put("customName", ReadProperty.getProperty("customName"));
				//requestParams.put("reportName", ReadProperty.getProperty("reportName"));  
					 	 
			// Add JSON body in the request and send the Request
			httpRequest.body(requestParams.toString());	
			Response response = (Response) httpRequest.post(ReadProperty.getProperty("New_Scenario_Add_Rule_Group_POST_URL")); 
		  ...
		  /*
	        ...
	        */
 			...
 			System.out.println("****************************** End of POST Price New Scenario Add Rule Group Test ******************************");
 			System.out.println("\n");
