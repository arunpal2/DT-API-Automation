...
public class POST_Price_Detailed_Scenario_POST_URL_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 				
	 ...
	 {	 
		 System.out.println("******************* POST POST Price Detailed Scenario API **************************");
		 System.out.println("\n");
		 ...
		 OkHttpClient client = new OkHttpClient().newBuilder()
				...
				RequestBody body = RequestBody.create(mediaType, "{\"pageIndex\":0,\"filters\":[],\"sorts\":[],\"exportType\":\"CSV\",\"widgetFilter\":null}");
				
				Request request = new Request.Builder()
				  .url(ReadProperty.getProperty("Price_Detailed_Scenario_POST_URL"))
				  .method("POST", body)
