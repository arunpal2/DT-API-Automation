...
public class POST_Price_Duplicate_Scenario_With_results_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 				
	 ...
	 @Test
     public void Test_POST_Price_Duplicate_Scenario_With_results_API() throws IOException
	 {	 
		 ...
		 System.out.println("\n");
				 ...
				 OkHttpClient client = new OkHttpClient().newBuilder()
						...
						Request request = new Request.Builder()
						  .url(ReadProperty.getProperty("Price_Duplicate_scenario_with_results_POST_URL"))
						  .method("POST", body)
