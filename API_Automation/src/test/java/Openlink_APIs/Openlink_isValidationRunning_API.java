...
public class Openlink_isValidationRunning_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 {	 
		 System.out.println("******************* GET Openlink is Validation Running API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Openlink_isValidationRunning_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Openlink is Validation Running API ******************************");
 			System.out.println("\n");
