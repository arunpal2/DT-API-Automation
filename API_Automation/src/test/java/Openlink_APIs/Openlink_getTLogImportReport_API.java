...
public class Openlink_getTLogImportReport_API 
{
	...
	{
		//RestAssured.baseURI = ReadProperty.getProperty("Openlink_getTLogImportReport_URL");
		//Thread.sleep(2000);
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Openlink_getTLogImportReport_API()
	 {	 
		 System.out.println("******************* GET Openlink getTLogImportReport API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Openlink_getTLogImportReport_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Openlink getTLogImportReport API ******************************");
 			System.out.println("\n");
