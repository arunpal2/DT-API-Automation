...
public class Openlink_getProductsByDemandGroup_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Openlink_getProductsByDemandGroup_API()
	 {	 
		 System.out.println("******************* GET Openlink get Products By Demand Group API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Openlink_getProductsByDemandGroup_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of Openlink get Products By Demand Group API ******************************");
 			System.out.println("\n");
