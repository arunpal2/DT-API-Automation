...
public class Openlink_getAutoRemodelVariableConfigList_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Openlink_getAutoRemodelVariableConfigList_API()
	 {	 
		 System.out.println("******************* GET Openlink getAutoRemodelVariableConfigList API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Openlink_getAutoRemodelVariableConfigList_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Openlink getAutoRemodelVariableConfigList API ******************************");
 			System.out.println("\n");
