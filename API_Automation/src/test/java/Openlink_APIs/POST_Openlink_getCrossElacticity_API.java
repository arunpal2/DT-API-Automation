...
public class POST_Openlink_getCrossElacticity_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_POST_Openlink_getCrossElacticity_API() throws IOException
	 {	 
		 System.out.println("******************* GET Openlink get CrossElacticity API **************************");
		 System.out.println("\n");
		 ...
		 OkHttpClient client = new OkHttpClient().newBuilder()
				...
				RequestBody body = RequestBody.create(mediaType, "{\"productCategoryID\":384,\"rowManufacturerIds\":[],\"rowBrandIds\":[],\"colManufacturerIds\":[],\"colBrandIds\":[]}");
				Request request = new Request.Builder()
				  .url(ReadProperty.getProperty("Openlink_getCrossElacticity_POST_URL"))
				  .method("POST", body)
		  ...
		  /*
		   ...
		   int statusCode = response.code();
 			...
 			System.out.println("****************************** End of GET Openlink get CrossElacticity API ******************************");
 			System.out.println("\n");
