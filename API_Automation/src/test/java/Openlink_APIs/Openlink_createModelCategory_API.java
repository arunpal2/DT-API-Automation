...
public class Openlink_createModelCategory_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Openlink_createModelCategory_API()
	 {	 
		 System.out.println("******************* GET Openlink create Model Category API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Openlink_createModelCategory_URL") + rand_int); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Openlink create Model Category API ******************************");
 			System.out.println("\n");
