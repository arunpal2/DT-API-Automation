...
public class Openlink_createNewCategory_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Openlink_createNewCategory_API()
	 {	 
		 System.out.println("******************* GET Openlink create New Category API **************************");
		 System.out.println("\n");
		 int rand_int = ThreadLocalRandom.current().nextInt();
		 String Catrgory_Name = "newCategoryName=New_customer_Category_API_Automation" + rand_int;
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Openlink_createNewCategory_URL") + Catrgory_Name); 		 		
