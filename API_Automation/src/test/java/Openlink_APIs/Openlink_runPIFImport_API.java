...
public class Openlink_runPIFImport_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 {	 
		 System.out.println("******************* GET Openlink Run PIF Import API **************************");
		 System.out.println("\n");
		 ...
		 //Response response = httpRequest.get(ReadProperty.getProperty("Openlink_runPIFImport_URL")); 
		 Response response = httpRequest.get("http://qa01.demandtec.com/qa01-sas01/openlink/restapi/runPIFImport?productCategoryID=28&importFileName=export_OL_BABYFOOD_FORMULA_DIAPERS_1.xls"); 
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Openlink Run PIF Import API ******************************");
 			System.out.println("\n");
