...
public class POST_Openlink_get_Validation_For_Finished_Status_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_POST_Openlink_get_Validation_For_Finished_Status_API() throws IOException
	 {	 
		 System.out.println("******************* GET Openlink get Validation For Finished Status API **************************");
		 System.out.println("\n");
		 ...
		 OkHttpClient client = new OkHttpClient().newBuilder()
				...
				RequestBody body = RequestBody.create(mediaType, "{\r\n\"productCategoryIds\":[0,20]\r\n}");
				
				    Request request = new Request.Builder()
				  .url(ReadProperty.getProperty("Openlink_get_Validation_For_Finished_Status_POST_URL"))
				  .method("POST", body)
		  ...
		  /*
		   ...
		   int statusCode = response.code();
 			...
 			System.out.println("****************************** End of GET Openlink get Validation For Finished Status API ******************************");
 			System.out.println("\n");
