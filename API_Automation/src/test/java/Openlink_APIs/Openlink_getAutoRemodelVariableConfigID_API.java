...
public class Openlink_getAutoRemodelVariableConfigID_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Openlink_getAutoRemodelVariableConfigID_API()
	 {	 
		 System.out.println("******************* GET Openlink get Auto Remodel Variable ConfigID API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Openlink_getAutoRemodelVariableConfigID_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of Openlink get Auto Remodel Variable ConfigID API ******************************");
 			System.out.println("\n");
