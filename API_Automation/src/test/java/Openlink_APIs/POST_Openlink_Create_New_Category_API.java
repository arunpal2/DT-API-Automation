...
public class POST_Openlink_Create_New_Category_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_POST_Openlink_Create_New_Category_API() throws IOException
	 {	 
		 System.out.println("******************* GET Openlink Create New Category API **************************");
		 System.out.println("\n");
		 ...
		 OkHttpClient client = new OkHttpClient().newBuilder()
				...
				RequestBody body = RequestBody.create(mediaType, "{\"newDemandCategories\":[{\"categoryID\":0,\"categoryName\":\"API_CAT_12\",\"defDemandGroupID\":0,\"defDTcatID\":0}]}");
				
				Request request = new Request.Builder()
				  .url(ReadProperty.getProperty("Openlink_Create_New_Category_POST_URL"))
				  .method("POST", body)
		  ...
		  /*
		   ...
		   int statusCode = response.code();
 			...
 			System.out.println("****************************** End of GET Openlink Create New Category API ******************************");
 			System.out.println("\n");
