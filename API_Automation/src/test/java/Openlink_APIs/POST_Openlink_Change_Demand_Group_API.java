...
public class POST_Openlink_Change_Demand_Group_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_POST_Openlink_Change_Demand_Group_API() throws IOException
	 {	 
		 System.out.println("******************* GET Openlink Change Demand Group API **************************");
		 System.out.println("\n");
		 ...
		 OkHttpClient client = new OkHttpClient().newBuilder()
				...
				RequestBody body = RequestBody.create(mediaType, "{\"newDemandGroupID\":2703,\"productIds\":[65679]}");
				
				Request request = new Request.Builder()
				  .url(ReadProperty.getProperty("Openlink_Change_Demand_Group_POST_URL"))
				  .method("POST", body)
		  ...
		  /*
		   ...
		   int statusCode = response.code();
 			...
 			System.out.println("****************************** End of GET Openlink Change Demand Group API ******************************");
 			System.out.println("\n");
