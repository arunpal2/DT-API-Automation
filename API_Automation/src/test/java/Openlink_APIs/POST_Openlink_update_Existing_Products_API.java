...
public class POST_Openlink_update_Existing_Products_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_POST_Openlink_update_Existing_Products_API() throws IOException
	 {	 
		 System.out.println("******************* GET Openlink update Existing Products API **************************");
		 System.out.println("\n");
		 ...
		 OkHttpClient client = new OkHttpClient().newBuilder()
				...
				RequestBody body = RequestBody.create(mediaType, "{\"nodeIDList\":[9,1662]}");
				    
				    Request request = new Request.Builder()
				  .url(ReadProperty.getProperty("Openlink_update_Existing_Products_POST_URL"))
				  .method("POST", body)
		  ...
		  /*
		   ...
		   int statusCode = response.code();
 			...
 			System.out.println("****************************** End of GET Openlink update Existing Products API ******************************");
 			System.out.println("\n");
