...
public class Openlink_runPIFExport_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Openlink_runPIFExport_API()
	 {	 
		 System.out.println("******************* GET Openlink runPIFExport API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get("https://qa01.demandtec.com/qa01-sas01/openlink/restapi/runPIFExport?productCategoryID=28&dropOutdatedProducts=false&hideDroppedProducts=false&assignLineGroups=false&lineGroupKeepExistingValues=false&assignSizeRelationships=false&sizeRelationshipKeepExistingValues=false"); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Openlink runPIFExport API ******************************");
 			System.out.println("\n");
