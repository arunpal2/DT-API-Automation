...
public class POST_Openlink_edit_Auto_Remodel_Variable_Config_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_POST_POST_Openlink_edit_Auto_Remodel_Variable_Config_API() throws IOException
	 {	 
		 System.out.println("******************* GET Openlink edit Auto Remodel Variable Config API **************************");
		 System.out.println("\n");
		 ...
		 OkHttpClient client = new OkHttpClient().newBuilder()
				...
				RequestBody body = RequestBody.create(mediaType, "{\"variableConfigVO\":{\"autoRemodelVariableConfigID\":5,\"variableName\":\"CATEGORY\",\"description\":\"sample test\",\"overrideValue\":\"20\",\"categories\":\"Multiple\"},\"productCategoryIdList\":[51,454,455]}");
				
				Request request = new Request.Builder()
				  .url(ReadProperty.getProperty("Openlink_edit_Auto_Remodel_Variable_Config_POST_URL"))
				  .method("POST", body)
		  ...
		  /*
		   ...
		   int statusCode = response.code();
 			...
 			System.out.println("****************************** End of GET Openlink edit Auto Remodel Variable Config API ******************************");
 			System.out.println("\n");
