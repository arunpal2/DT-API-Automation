...
public class Openlink_saveDemandGroup_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Openlink_saveDemandGroup_API()
	 {	 
		 System.out.println("******************* GET Openlink save Demand Group API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Openlink_saveDemandGroup_URL") + rand_int); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Openlink save Demand Group API ******************************");
 			System.out.println("\n");
