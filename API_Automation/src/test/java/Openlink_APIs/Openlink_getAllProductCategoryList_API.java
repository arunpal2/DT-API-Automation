...
public class Openlink_getAllProductCategoryList_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Openlink_getAllProductCategoryList_API()
	 {	 
		 System.out.println("******************* GET Openlink getAllProductCategoryList API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Openlink_getAllProductCategoryList_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Openlink getAllProductCategoryList API ******************************");
 			System.out.println("\n");
