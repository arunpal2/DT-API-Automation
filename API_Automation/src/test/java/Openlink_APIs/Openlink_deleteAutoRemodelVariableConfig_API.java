...
public class Openlink_deleteAutoRemodelVariableConfig_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Openlink_deleteAutoRemodelVariableConfig_API()
	 {	 
		 System.out.println("******************* GET Openlink delete Auto Remodel Variable Config API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Openlink_deleteAutoRemodelVariableConfig_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of Openlink delete Auto Remodel Variable Config API ******************************");
 			System.out.println("\n");
