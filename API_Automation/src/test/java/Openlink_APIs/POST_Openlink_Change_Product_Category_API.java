...
public class POST_Openlink_Change_Product_Category_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_POST_Openlink_Change_Product_Category_API() throws IOException
	 {	 
		 System.out.println("******************* GET Openlink Change Product Category API **************************");
		 System.out.println("\n");
		 ...
		 OkHttpClient client = new OkHttpClient().newBuilder()
				...
				RequestBody body = RequestBody.create(mediaType, "{\r\n\"productIds\":[65679],\r\n\"oldProductCategoryID\":46,\r\n\"newProductCategoryID\":47\r\n}");
				
				Request request = new Request.Builder()
				  .url(ReadProperty.getProperty("Openlink_Change_Product_Category_POST_URL"))
				  .method("POST", body)
		  ...
		  /*
		   ...
		   int statusCode = response.code();
 			...
 			System.out.println("****************************** End of GET Openlink Change Product Category API ******************************");
 			System.out.println("\n");
