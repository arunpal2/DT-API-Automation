...
public class POST_Openlink_Save_Category_Mapping_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_POST_Openlink_Save_Category_Mapping_API() throws IOException
	 {	 
		 System.out.println("******************* GET Openlink save Category Mapping API **************************");
		 System.out.println("\n");
		 ...
		 OkHttpClient client = new OkHttpClient().newBuilder()
				...
				RequestBody body = RequestBody.create(mediaType, "{\"changeList\":[{\"customerCategoryID\":30,\"demandCatID\":0,\"pOperation\":2}]}");
				
				Request request = new Request.Builder()
				  .url(ReadProperty.getProperty("Openlink_Save_Category_Mapping_POST_URL"))
				  .method("POST", body)
		  ...
		  /*
		   ...
		   int statusCode = response.code();
 			...
 			System.out.println("****************************** End of GET Openlink save Category Mapping API ******************************");
 			System.out.println("\n");
