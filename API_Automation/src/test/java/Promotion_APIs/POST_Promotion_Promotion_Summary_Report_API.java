...
public class POST_Promotion_Promotion_Summary_Report_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 				
	 ...
	 @Test
     public void Test_POST_Promotion_Promotion_Summary_Report_API() throws IOException
	 {	 
		 System.out.println("******************* POST Promotion Summary Report API **************************");
		 System.out.println("\n");
		 ...
		 OkHttpClient client = new OkHttpClient().newBuilder()
				...
				RequestBody body = RequestBody.create(mediaType, "{\"pageIndex\":0,\"filters\":[],\"sorts\":[]}");
				
				Request request = new Request.Builder()
				  .url(ReadProperty.getProperty("Promotion_Promotion_Summary_Report_URL"))
				  .method("POST", body)
		  ...
		  /*
		   ...
		   int statusCode = response.code();
			...
			//Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of POST Promotion Summary Report API Test ******************************");
 			System.out.println("\n");
