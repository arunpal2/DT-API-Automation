...
public class Promotion_getDuplicatePromoName_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Promotion_getDuplicatePromoName_API()
	 {	 
		 System.out.println("******************* GET Duplicate Promo Name API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Promotion_getDuplicatePromoName_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Duplicate Promo Name API ******************************");
 			System.out.println("\n");
