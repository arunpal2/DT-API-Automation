...
public class Promotion_dupMoveValidationSave_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Promotion_dupMoveValidationSave_API()
	 {	 
		 System.out.println("******************* GET dup Move Validation Save API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Promotion_dupMoveValidationSave_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET dup Move Validation Save API ******************************");
 			System.out.println("\n");
