...
public class Promotion_getProductPickerDropDownsOptions_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Promotion_getProductPickerDropDownsOptions_API()
	 {	 
		 System.out.println("******************* GET Promotion Product Picker DropDowns Options API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Promotion_getProductPickerDropDownsOptions_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Promotion Product Picker DropDowns Options API ******************************");
 			System.out.println("\n");
