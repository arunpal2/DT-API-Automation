...
public class Promotion_RemoveAllAfterValidation_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Promotion_RemoveAllAfterValidation_API()
	 {	 
		 System.out.println("******************* GET Remove All After Validation API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Promotion_RemoveAllAfterValidation_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Remove All After Validation API ******************************");
 			System.out.println("\n");
