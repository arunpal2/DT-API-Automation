...
public class Promotion_getAllPromotionDetailTypes_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Promotion_getAllPromotionDetailTypes_API()
	 {	 
		 System.out.println("******************* GET Promotion get All Promotion Detail Types API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Promotion_getAllPromotionDetailTypes_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Promotion get All Promotion Detail Types API ******************************");
 			System.out.println("\n");
