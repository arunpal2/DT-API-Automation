...
public class Promotion_doPastDataValidation_API
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Promotion_doPastDataValidation_API()
	 {	 
		 System.out.println("******************* GET do Past Data Validation API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Promotion_doPastDateValidation_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET do Past Data Validation API ******************************");
 			System.out.println("\n");
