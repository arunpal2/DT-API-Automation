...
public class Promotion_PromoWidgetDetails_PriceConflictPromos1_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Promotion_PromoWidgetDetails_PriceConflictPromos1_API()
	 {	 
		 System.out.println("******************* GET Promotion WidgetDetails PriceConflict Promos API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Promotion_PromoWidgetDetails_PriceConflictPromos_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Promotion WidgetDetails PriceConflict Promost API ******************************");
 			System.out.println("\n");
