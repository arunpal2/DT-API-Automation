...
public class Promotion_getWidgetDetailPromotionList_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Promotion_getWidgetDetailPromotionList_API()
	 {	 
		 System.out.println("******************* GET Promotion Widget Detail Promotion List API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Promotion_getWidgetDetailPromotionList_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Promotion Widget Detail Promotion List API ******************************");
 			System.out.println("\n");
