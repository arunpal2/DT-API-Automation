...
public class Promotion_getWidgetDetailPromotionList1_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Promotion_getWidgetDetailPromotionList1_API()
	 {	 
		 System.out.println("******************* GET Promotion Widget Detail PromotionList API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Promotion_getWidgetDetailPromotionLis_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Promotion Widget Detail PromotionList API ******************************");
 			System.out.println("\n");
