...
public class POST_Promotion_getQuickSearchProducts 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 				
	 ...
	 @Test
     public void Test_POST_Promotion_getQuickSearchProducts() throws IOException
	 {	 
		 System.out.println("******************* POST Promotion get Quick Search Products **************************");
		 System.out.println("\n");
		 ...
		 OkHttpClient client = new OkHttpClient().newBuilder()
				...
				RequestBody body = RequestBody.create(mediaType, "{\"productIdentifiers\":\"00022067_00000\",\"searchType\":\"upc\"}");
				
				Request request = new Request.Builder()
				  .url(ReadProperty.getProperty("Promotion_getQuickSearchProducts_URL"))
				  .method("POST", body)
		  ...
		  /*
		   ...
		   int statusCode = response.code();
			...
			//Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of POST Promotion get Quick Search Products Test ******************************");
 			System.out.println("\n");
