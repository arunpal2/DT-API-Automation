...
public class Promotion_newpromoPG_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Promotion_newpromoPG_API() throws IOException
	 {	 
		 System.out.println("******************* GET Promotion new promo PG API **************************");
		 System.out.println("\n");
		 OkHttpClient client = new OkHttpClient().newBuilder()
				...
				Request request = new Request.Builder()
				  .url(ReadProperty.getProperty("Promotion_newpromoPG_URL"))
				  .method("GET", null)
		  ...
		  /*
		   ...
		   int statusCode = response.code();
			...
			//Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Promotion new promo PG API ******************************");
 			System.out.println("\n");
