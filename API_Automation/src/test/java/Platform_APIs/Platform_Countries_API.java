...
public class Platform_Countries_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Platform_Countries_API()
	 {	 
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Platform_Countries_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Countries API ******************************");
 			System.out.println("\n");
