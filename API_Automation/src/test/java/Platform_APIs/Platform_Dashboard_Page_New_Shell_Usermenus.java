...
public class Platform_Dashboard_Page_New_Shell_Usermenus 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Platform_Dashboard_Page_New_Shell_Usermenus()
	 {	 
		 System.out.println("******************* GET Dashboard Page New Shell User Menus API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Platform_Dashboard_Page_New_Shell_Usermenus")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Dashboard Page New Shell User Menus API ******************************");
 			System.out.println("\n");
