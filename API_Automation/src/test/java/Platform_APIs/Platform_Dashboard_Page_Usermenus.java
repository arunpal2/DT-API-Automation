...
public class Platform_Dashboard_Page_Usermenus 
{
...
//		
	 ...
	 @Test
     public void Test_Platform_Dashboard_Page_Usermenus()
	 {	 
		 System.out.println("******************* GET Dashboard Page User apps API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Platform_Dashboard_Page_Usermenus")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Dashboard Page User apps API ******************************");
 			System.out.println("\n");
