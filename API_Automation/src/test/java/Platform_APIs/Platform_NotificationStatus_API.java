...
public class Platform_NotificationStatus_API 
{
...
//		
	 ...
	 @Test
     public void Test_Platform_NotificationStatus_API()
	 {	 
		 System.out.println("******************* GET Notification Status API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Platform_NotificationStatuses_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Notification Status API ******************************");
 			System.out.println("\n");
