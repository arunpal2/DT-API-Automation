...
public class Platform_Notes_API 
{
...
//		
	 ...
	 @Test
     public void Test_Platform_Notes_API()
	 {	 
		 System.out.println("******************* GET Platform Notes **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Platform_Notes_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Platform Notes ******************************");
 			System.out.println("\n");
