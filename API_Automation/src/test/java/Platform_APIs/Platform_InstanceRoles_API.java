...
public class Platform_InstanceRoles_API 
{
...
//				System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Platform_InstanceRoles_API()
	 {	 
		 System.out.println("******************* GET Instance Role API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Platform_InstanceRoles_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Instance Role API ******************************");
 			System.out.println("\n");
