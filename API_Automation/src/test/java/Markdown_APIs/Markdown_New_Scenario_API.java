...
public class Markdown_New_Scenario_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Markdown_New_Scenario_API()
	 {	 
		 System.out.println("******************* GET Markdown New Scenario API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Markdown_New_Scenario_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Markdown New Scenario API ******************************");
 			System.out.println("\n");
