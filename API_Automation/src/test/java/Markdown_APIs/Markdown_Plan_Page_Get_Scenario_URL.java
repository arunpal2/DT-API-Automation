...
public class Markdown_Plan_Page_Get_Scenario_URL 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Markdown_Plan_Page_Get_Scenario_URL()
	 {	 
		 System.out.println("******************* GET Markdown Plan Page Get Scenario API **************************");
		 System.out.println("\n");

		 RequestSpecification httpRequest = given().header("Host", ReadProperty.getProperty("HOST")).header("Cookie",ReadProperty.getProperty("MARKDOWN_COOKIE"));		
		 Response response = httpRequest.get(ReadProperty.getProperty("Markdown_Plan_Page_Get_Scenario_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Markdown Plan Page Get Scenario API ******************************");
 			System.out.println("\n");
