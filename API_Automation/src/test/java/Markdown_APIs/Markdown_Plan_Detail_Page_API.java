...
public class Markdown_Plan_Detail_Page_API 
{
...
//		System.out.println("Access Token is:::::: " +accessToken); 	
	 ...
	 @Test
     public void Test_Markdown_Plan_Detail_Page_API()
	 {	 
		 System.out.println("******************* GET Markdown Plan Detail Page API **************************");
		 System.out.println("\n");
		 ...
		 Response response = httpRequest.get(ReadProperty.getProperty("Markdown_Plan_Detail_Page_URL")); 		 		
...
// 			Assert.assertEquals(bodyAsString.contains("GetOfferAPI-1") /*Expected value*/, true /*Actual Value*/, "Response body contains GetOfferAPI-1");
 			...
 			System.out.println("****************************** End of GET Markdown Plan Detail Page API ******************************");
 			System.out.println("\n");
